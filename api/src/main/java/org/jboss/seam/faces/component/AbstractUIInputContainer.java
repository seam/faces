...
/**
 * <strong>AbstractUIInputContainer</strong> is an abstraction to hold common functionalities for a InputContainer.
 * 
 * 
 * @author <a href="http://community.jboss.org/people/spinner)">Jose Rodolfo freitas</a>
 */
public abstract class AbstractUIInputContainer extends UIComponentBase implements NamingContainer {
    ...
    public AbstractUIInputContainer() {
    ...
    public void encodeBegin(final FacesContext context) throws IOException {
        ...
        /*
         * EL expressions are never pushed to the attributes map. There's a separate store, under the set/get ValueExpression
         * methods.
         * 
         * Non-el expressions are put into the attributes map, unless they are properties, in which case they get pushed into
         * the getter/setter.
         */
    ...
    abstract protected void postScan(final FacesContext context, InputContainerElements elements);
