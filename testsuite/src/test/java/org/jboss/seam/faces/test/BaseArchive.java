...
public class BaseArchive {
    ...
    public static WebArchive baseWar(final String archiveName, final boolean includeEmptyBeansXml) {
        final WebArchive archive = ShrinkWrap.create(WebArchive.class, archiveName);
