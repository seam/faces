...
/**
 * 
 * This tests checks if the {@link ProjectStageExtension} works correctly for project stages defined in web.xml.
 * 
 * @author Christian Kaltepoth <christian@kaltepoth.de>
 * 
 */
@RunWith(Arquillian.class)
public class WebXmlProjectStageExtensionTest {
    ...
    public static WebArchive createTestArchive() {
        return ProjectStageBaseArchive.getBaseArchive()
                ...
                .addAsWebInfResource("org/jboss/seam/faces/test/server/projectstage/context-param-web.xml", "web.xml");
    }
    ...
    public void testActivatedBeansInDefaultProjectStage() {
        ...
        /*
         * The project stage in web.xml is set to DEVELOPMENT. Therefore the ProductionStageBean is vetoed.
         */
        assertEquals(1, beanManager.getBeans(DevelopmentStageBean.class).size());
        assertEquals(0, beanManager.getBeans(ProductionStageBean.class).size());
