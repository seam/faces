...
/**
 * Wrap the built-in {@link ViewDeclarationLanguage} implementation for the purpose of 
 * wrapping the {@link ViewMetadata} implementation in {@link SeamViewMetadata}.
 * 
...
public class SeamViewDeclarationLanguage extends ViewDeclarationLanguage
{
   ...
   /**
    * If non-null, wrap the {@link ViewMetadata} returned by the delegate in
    * a new instance of {@link SeamViewMetadata}.
    */
   @Override
